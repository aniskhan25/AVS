...
function audio_visual_correlation_v1 (video_name, frameRate)
...
allTracks = load(sprintf('../Data/Video/%s/allTracks', video_name)); allTracks = allTracks.allTracks;
allLabels = load(sprintf('../Data/Video/%s/allLabels', video_name)); allLabels = allLabels.allLabels;
...
audio_features_raw = abs(faudio.audio_features);
